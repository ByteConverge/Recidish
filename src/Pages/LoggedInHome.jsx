...
import LoggedInHeroSection from "../Recidish_Components/LoggedInHeroSection";
import Footer from "../Recidish_Components/Footer";
import LoggedInNavBar from "../Recidish_Components/LoggedInNavbar";
...
export default function LoggedInHomePage() {
  return (
    <>
      ...
      <LoggedInHeroSection />
      {/* Homepage body */}
      <div className="min-h-[100dvh] my-[1rem] sm:w-[95%] sm:mx-auto ">
        {/* welcome Flavors one */}
        <div
          id="welcomeFlavors"
          className="min-h-[80dvh] sm:flex  sm:mb-[3rem] sm:w-[100%] sm:gap-3  sm:h-[80vh]"
        >
          <div
            id="text"
          ...
          <div
            id="img"
            className="min-h-[50dvh] sm:h-[100%]  sm:rounded-[25px] "
          >
            <img
              src={flavorDish}
              alt=""
        ...
        <div
          ...
          className="min-h-[80dvh] sm:flex  sm:mb-[3rem] sm:w-[100%] sm:gap-8 sm:flex-row-reverse sm:justify-between "
        >
          <div
            id="text"
